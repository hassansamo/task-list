...
<div class="flex gap-2">
    ...
    <form action="<?php echo e(route('tasks.toggle', ['task' => $task])); ?>" method="post">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\task-list\resources\views/show.blade.php ENDPATH**/ ?>